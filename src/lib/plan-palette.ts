...
export const PLAN_PALETTE: PlanColor[] = [
  ...
  { key: "sage",  label: "Sage green", hex: "#7C8A6B", tint: "#EEF1E8", onHex: "#FBF8ED" },
  { key: "clay",  label: "Clay",       hex: "#A8552F", tint: "#F6E8E1", onHex: "#FBF8ED" },
  { key: "slate", label: "Slate blue", hex: "#4A5D7E", tint: "#E9EDF3", onHex: "#FBF8ED" },
  // Brighter options
  { key: "limelight", label: "Lime",   hex: "#DCE07A", tint: "#F6F7E2", onHex: "#181A4D" },
  { key: "sky",       label: "Blue",   hex: "#2E9BE6", tint: "#E3F1FC", onHex: "#FBF8ED" },
  { key: "amber",     label: "Orange", hex: "#FFAE00", tint: "#FFF3DB", onHex: "#181A4D" },
  { key: "coral",     label: "Red",    hex: "#FF6B4A", tint: "#FFE7E1", onHex: "#FBF8ED" },
  { key: "grass",     label: "Green",  hex: "#4FA92B", tint: "#E8F5E1", onHex: "#FBF8ED" },
];

/** Retired colors — kept only so older plans still render their saved color. */
const LEGACY_COLORS: PlanColor[] = [
...
export function planColor(key: string | null | undefined): PlanColor {
  return (
    PLAN_PALETTE.find((c) => c.key === key) ??
    LEGACY_COLORS.find((c) => c.key === key) ??
    PLAN_PALETTE[0]
  );
}
