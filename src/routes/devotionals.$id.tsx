...
/* Tablet & desktop: keep the three columns proportionate — long entries
   scroll inside their own box instead of stretching the whole card. */
@media (min-width:900px){
...
function EntryPage() {
  ...
  const addTodoItem = () => {
    ...
    // New tasks are appended to the bottom of the existing list.
                  ...
                  <div style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: selectedDate === todayISO() ? "#181A4D" : "#0F4A42",
...
// ============================================================================
// User events (Prayer meeting, Bible study, Discipleship, Other)
// ============================================================================
...
const EVENT_TYPE_META: Record<Exclude<UserEventType, "other">, { label: string; color: string }> = {
  ...
  mentor_meeting: { label: "Discipleship", color: "#8A96E0" },
};
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                {([
                  ...
                  ["mentor_meeting", "Discipleship", "#8A96E0"],
