  ...
  return (
    <AppShell>
      ...
      <style>{`
        ...
        .rd-full-body{flex:1;overflow-y:auto;padding:40px max(24px,4vw) 96px;max-width:1500px;width:100%;margin:0 auto;box-sizing:border-box;display:flex;flex-direction:column;}
